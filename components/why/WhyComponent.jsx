const WhyComponent = () => {
    return (
        <>
        <br></br><br></br><br></br>
        <section className="p-4 lg:p-8 dark:bg-gray-800 dark:text-gray-100 mb-8">
  ...
  <div className="w-6/12 sm:w-4/12 px-4">
    <img src="/heros/writing.jpg" alt="..." className="shadow rounded-lg max-w-full h-auto align-middle border-none" />
			...
			<div className="flex flex-col justify-center flex-1 p-6 dark:bg-gray-900">
				...
				<p className="my-6 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor aliquam possimus quas, error esse quos.
